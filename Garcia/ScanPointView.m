...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    if ((self = [super initWithCoder:aDecoder])){
        UIView *subView = [[[NSBundle mainBundle] loadNibNamed:@"ScanPointView" owner:self options:nil] objectAtIndex:0];
        ...
        [_scanPointTableView reloadData];
    }
    return self;
}
