...
@property (weak, nonatomic) IBOutlet UIButton *completeSelectDeselectBtn;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *previousSittingCollectionViewHeight;
