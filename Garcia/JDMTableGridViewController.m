...
- (void)viewDidLoad {
    ...
    NSArray *toolBarItems = [NSArray arrayWithObjects:
                             [[UIBarButtonItem alloc] initWithTitle:@"+ Row" style:UIBarButtonItemStyleBordered target:self action:@selector(addRow:)],
                             [[UIBarButtonItem alloc] initWithTitle:@"- Row" style:UIBarButtonItemStyleBordered target:self action:@selector(delRow:)],
                             [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:nil action:nil],
                             [[UIBarButtonItem alloc] initWithTitle:@"+ Col" style:UIBarButtonItemStyleBordered target:self action:@selector(addCol:)],
                             [[UIBarButtonItem alloc] initWithTitle:@"- Col" style:UIBarButtonItemStyleBordered target:self action:@selector(delCol:)],
                             nil];
    [self setToolbarItems:toolBarItems animated:YES];
    [[self navigationController] setToolbarHidden:NO];
    
    [self setTableGridView:[[JDMTableGridView alloc] initWithFrame:self.view.bounds]];
